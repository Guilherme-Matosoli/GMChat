...
export class Default1715886668725 implements MigrationInterface {
    name = 'Default1715886668725'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "messages" ("id" character varying NOT NULL, "content" text NOT NULL, "time" TIMESTAMP WITH TIME ZONE NOT NULL, "chatId" character varying, "user" text, CONSTRAINT "PK_18325f38ae6de43878487eff986" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "messages" ADD CONSTRAINT "FK_e992d71af54f66639d5b90a7cfc" FOREIGN KEY ("user") REFERENCES "users"("username") ON DELETE NO ACTION ON UPDATE NO ACTION`);
