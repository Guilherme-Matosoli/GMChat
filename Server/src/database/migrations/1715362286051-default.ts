...
export class Default1715362286051 implements MigrationInterface {
    name = 'Default1715362286051'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "messages" ("id" character varying NOT NULL, "content" text NOT NULL, "time" TIMESTAMP WITH TIME ZONE NOT NULL, "chatId" character varying, "sender" text, CONSTRAINT "PK_18325f38ae6de43878487eff986" PRIMARY KEY ("id"))`);
